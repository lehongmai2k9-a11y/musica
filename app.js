...
console.log("[Musica] app.js v2.11 (playable arc chips + scrollable arcs)");
...
function renderArcs() {
  ...
  groups.forEach((group) => {
    ...
    // ★ Chip chương: bấm = phát bài đầu tiên của chương đó
...
// ★ Render danh sách chapter (kèm nhãn số arc)
